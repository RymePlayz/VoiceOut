...
public class RegisterForm extends javax.swing.JFrame {
    ...
    public RegisterForm() {
        ...
        goToLoginLbl.addMouseListener(new java.awt.event.MouseAdapter() {
    @Override
    ...
    public void mouseEntered(java.awt.event.MouseEvent evt) {
        goToLoginLbl.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    }
});
    ...
    private void initComponents() {
        ...
        GenderComBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Prefer not to say", "Male", "Female" }));
    ...
    private void GenderComBoxActionPerformed(java.awt.event.ActionEvent evt) {
   ...
   private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {                                             
    ...
    if (userNameFld.getText().trim().isEmpty()) {
        ...
        if (!userNameFld.getText().trim().matches("\\d+")) {
    ...
    if (nameFld.getText().trim().isEmpty()) {
        ...
        if (nameFld.getText().trim().length() <= 4) {
    ...
    if (passwordFld.getText().trim().isEmpty()) {
        ...
        if (passwordFld.getText().trim().length() <= 6) {
    ...
    if (cNumberFld.getText().trim().isEmpty()) {
        ...
        if (!cNumberFld.getText().trim().matches("\\d{11}")) {
    ...
    private static javax.swing.JLabel goToLoginLbl;
